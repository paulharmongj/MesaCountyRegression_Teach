...
par(mar = c(2,1,3,1))
#create a mosaicplot
mosaicplot(table(sw.new.f$Trekkie, sw.new.f$Ynew), col = c("blue3",'orange2'), main = "Trek Fan Status vs. Whether Respondent Has Seen Star Wars")
mosaicplot(table(sw.new.f$Gender,sw.new.f$Ynew), col = c("blue3",'orange2'), main = "Gender vs. Whether Respondent Has Seen Star Wars")
mosaicplot(table(sw.new.f$Age,sw.new.f$Ynew), col = c("blue3",'orange2'), las = 2, main = "Age vs. Whether Respondent Has Seen Star Wars")
mosaicplot(table(sw.new.f$Income,sw.new.f$Ynew), col = c("blue3",'orange2'), las = 2, main = "Income vs. Whether Respondent Has Seen Star Wars")
mosaicplot(table(sw.new.f$Education,sw.new.f$Ynew), col = c("blue3",'orange2'), las = 1, main = "Education Level vs. Whether Respondent Has Seen Star Wars")
mosaicplot(table(sw.new.f$Location,sw.new.f$Ynew), col = c("blue3",'orange2'), las = 2, cex = .6, main = "Location vs. Whether Respondent Has Seen Star Wars")
...
Based on these plots, which variables do you think are important? This is a bit of a subjective question, but it certainly appears that **Trek Fan status, Age,** and **Gender** are important whereas Location, Education, and Income might not be quite as important. 
...
Let's check the AUC of the model and examine a plot.  
